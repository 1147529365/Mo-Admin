...
CREATE TABLE `u_file` (
                          ...
                          `filetitle` text COMMENT '文章标题',
                          `filecontent` text COMMENT '文章内容',
                          `appid` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `u_img_list` (
                              `pgid` int(11) NOT NULL,
                              `id` int(11) NOT NULL,
                              `img_name` varchar(64) DEFAULT '首页图片',
                              `img_group` varchar(12) DEFAULT 'default',
                              `img_state` enum('on','off') DEFAULT 'on',
                              `img_off_msg` varchar(255) DEFAULT '当前图片维护中',
                              `img_url` text,
                              `appid` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- 表的索引 `u_img_group`
--
ALTER TABLE `u_img_group`
    ADD PRIMARY KEY (`id`);

--
-- 表的索引 `u_img_list`
--
ALTER TABLE `u_img_list`
    ADD PRIMARY KEY (`id`);
...
--
-- 使用表AUTO_INCREMENT `u_img_group`
--
ALTER TABLE `u_img_group`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `u_img_list`
--
ALTER TABLE `u_img_list`
    MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
