<?php include_once 'header.php'; ?>
                            ...
                            <div class="form-row">
                                <div class="form-group col-auto mr-auto">
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#add">
                                        <i class="fe fe-plus fe-12 mr-2"></i><span class="small">添加卡密</span>
                                    </button>
                                </div>
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            <label>卡密长度<span class="fe fe-help-circle ml-1" data-toggle="tooltip"
                                                 title="可自定义卡密长度，为保证卡密唯一性，卡密长度仅可在16~32位字符区间"></span></label>
                            ...
                            <div class="float-right">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="add_out"
                                           onchange="out_select(this.checked)">
                                ...
                                <div class="card bg-primary">
                                    <div class="card-body profile-user-box">
                                                                    ...
                                                                    <div class="float-left">
                                                                        <div class="custom-switch">
                                                                            <input type="checkbox"
                                                                                   ...
                                                                                   id="edit_state"
                                                                                   onchange="checked_state(this.checked);"
                                                                                   checked>
                                                                            <label class="custom-control-label success"
                                                                                   for="edit_state"></label>
                                                                        </div>
                                                                    </div>
                                                                    <label class="mb-0"
                                                                           id="edit_state_label">正常</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item bg-primary border-bottom-primary">
                                                <p class="d-flex justify-content-between align-items-center mb-0 text-white">
                                                    创建时间 <span class="col-auto"
                                                                   id="edit_add_time">2023-06-08 23:12</span>
                                                </p>
                                            </li>
                                            <li class="list-group-item bg-primary border-bottom-primary">
                                                <p class="d-flex justify-content-between align-items-center mb-0 text-white">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <label>备注</label>
                                                <input type="text" class="form-control" placeholder="设置卡密的备注"
                                                       id="edit_km_note">
                                            </div>
                                        </form>
                                    </div> <!-- end card-body -->
                                ...
                                <div class="card mb-3" id="edit_use_info" hidden>
                                    <div class="card-body">
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <p class="d-flex justify-content-between align-items-center mb-0 text-uppercase">
                                                    使用时间 <span class="col-auto"
                                                                   id="edit_use_time">2023-06-08 23:12</span>
                                                </p>
                                            </li>
                                            <li class="list-group-item">
                                                <p class="d-flex justify-content-between align-items-center mb-0 text-uppercase">
            ...
            <div class="modal-content">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <p class="mt-3">确认删除卡密：<strong class="text-danger me-1" id="del_name">null</strong> ？<br>删除后不可恢复！请慎重操作
                        </p>
    ...
    <script>
        ...
        $("#add_submit").click(function () {
            var t = {act: "add"};
            return t.kgid = $("#add_kmg").val(), t.note = $("#add_km_note").val(), t.length = $("#add_km_length").val(), t.pre = $("#add_km_pre").val(), t.num = $("#add_num").val(), t.out = $("#add_out").prop("checked") ? "y" : "n", t.out_type = $("#add_out_type").val(), $("#add_submit").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>正在提交'), $("#add_submit").attr("disabled", !0), $.ajax({
                cache: !1,
                type: "POST",
                data: t,
                dataType: "json",
                success: function (e) {
                    $("#add_submit").html("确认添加"), $("#add_submit").attr("disabled", !1), 200 == e.code ? (cocoMessage.success(e.msg, 3e3), init(initSubmit), "y" == t.out && (window.location.href = e.data.downUrl), $("#add_km_note").val(""), $("#add_out").prop("checked", !1), out_select(!1), $("#add_num").val("1"), $("#add").modal("hide")) : cocoMessage.error(e.msg, 3e3)
                },
                error: function (t, e, d) {
                    cocoMessage.error("系统发生错误，请打开浏览器调试模式查看具体原因", 3e3), $("#add_submit").html("确认添加"), $("#add_submit").attr("disabled", !1)
                }
            }), !1
        }), $("#edit_submit").click(function () {
            var t = {act: "edit"};
            return t.id = $("#edit_id").val(), t.note = $("#edit_km_note").val(), t.state = $("#edit_state").prop("checked") ? "y" : "n", $("#edit_submit").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>正在提交'), $("#edit_submit").attr("disabled", !0), $.ajax({
                cache: !1,
                type: "POST",
                data: t,
                dataType: "json",
                success: function (t) {
                    $("#edit_submit").html("确认编辑"), $("#edit_submit").attr("disabled", !1), 200 == t.code ? (add_list(t.data.list), cocoMessage.success("编辑成功", 3e3)) : cocoMessage.error(t.msg, 3e3)
                },
                error: function (t, e, d) {
                    cocoMessage.error("系统发生错误，请打开浏览器调试模式查看具体原因", 3e3), $("#edit_submit").html("确认编辑"), $("#edit_submit").attr("disabled", !1)
                }
            }), !1
            ...
            return $("#del_submit").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>正在删除'), $("#del_submit").attr("disabled", !0), $.ajax({
                ...
                dataType: "json",
                success: function (e) {
                    ($("#del_submit").html("确认删除"), $("#del_submit").attr("disabled", !1), 200 == e.code) ? ($("#list_" + t).remove(), cocoMessage.success(e.msg, 3e3), $("#del").modal("hide"), $("#tbody_list").children().length < 1 && init(initSubmit)) : cocoMessage.error(e.msg, 3e3)
                },
                error: function (t, e, d) {
                    cocoMessage.error("系统发生错误，请打开浏览器调试模式查看具体原因", 3e3), $("#add_submit").html("确认添加"), $("#add_submit").attr("disabled", !1)
                }
        ...
        function get_kmg(t = !1) {
            return !(!t && inikmg) && ($("#add_kmg_refresh").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>刷新中'), $.ajax({
                cache: !1,
                type: "POST",
                data: {act: "get_kmg"},
                dataType: "json",
                success: function (t) {
                    if (200 == t.code) {
                        ...
                        if (e.length >= 1) {
                            $("#add_kmg").empty();
                            for (var d = 0; d < e.length; d++) $("#add_kmg").append('<option value="' + e[d].id + '">' + e[d].name + "</option>");
                            inikmg = !0
                        } else $("#add_kmg").append('<option value="0">请先添加卡密组</option>')
                    }
                    $("#add_kmg_refresh").html("刷新")
                },
                error: function (t, e, d) {
                    $("#add_kmg_refresh").html("刷新")
                }
        ...
        function valTotype(t) {
            var e;
            return 9999999999 == t ? "永久" : t >= 86400 ? (e = t / 60 / 60 / 24, (isInteger(e) ? e : e.toFixed(2)) + "天") : t >= 3600 ? (e = t / 60 / 60, (isInteger(e) ? e : e.toFixed(2)) + "时") : t >= 60 ? (e = t / 60, (isInteger(e) ? e : e.toFixed(2)) + "分") : t + "秒"
        }
    </script>
