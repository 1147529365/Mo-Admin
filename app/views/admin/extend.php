                                ...
                                <div class="form-group col-auto mr-auto">
                                    <button type="button" class="btn btn-success" data-toggle="modal"
                                            data-target="#modal" onclick="modal_show()"><i
                                                class="fe fe-plus fe-12 mr-2"></i><span class="small">添加扩展</span>
                                    </button>
                                </div>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" id="extend_val" rows="16"
                                          placeholder="如：51154393"></textarea>
                            </div>
                        </div>
    ...
    <script>
        ...
        function add_list(t, e = !1) {
            ...
            for (var a = 0; a < t.length; a++) {
                var l = "<td>" + t[a].id + "</td><td>" + t[a].name + "</td><td>" + t[a].var_key + '</td><td class="text-left">' + "请编辑查看详情" + "</td>";
        ...
        function modal_show(t = null) {
            if (null != t) {
                ...
                $("#modal_title").html("编辑扩展"), $("#extend_id").val(a.id), $("#extend_name").val(a.name), $("#extend_key").val(a.var_key), $("#extend_val").val(a.var_val), $("#extend_all").val(isEmpty(a.appid) ? "y" : "n")
            } else $("#extend_id").val(""), $("#extend_name").val(""), $("#extend_val").val(""), $("#extend_key").val(""), $("#extend_all").val("n"), $("#modal_title").html("添加扩展")
        }
        ...
        $("#submit").click(function () {
            var t = {};
            return t.act = "编辑扩展" == $("#modal_title").html() ? "edit" : "add", "edit" == t.act && (t.id = $("#extend_id").val()), t.name = $("#extend_name").val(), t.var_key = $("#extend_key").val(), t.var_val = $("#extend_val").val(), t.all = $("#extend_all").val(), $("#submit").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>正在提交'), $("#submit").attr("disabled", !0), $.ajax({
                cache: !1,
                type: "POST",
                data: t,
                dataType: "json",
