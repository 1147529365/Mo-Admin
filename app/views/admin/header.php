			...
			<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
				...
				<nav class="vertnav navbar navbar-light">
					...
					<div class="w-100">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#img" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
                                <i class="fe fe-bar-chart-2 fe-16"></i>
                                <span class="ml-3 item-text">
										图片管理
									</span>
                            </a>
                            <ul class="collapse list-unstyled pl-4 w-100" id="img">
                                <li class="nav-item">
                                    <a class="nav-link pl-3" href="img_list">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link pl-3" href="img_group">
											<span class="ml-1 item-text">
												图片分组
											</span>
                                    </a>
