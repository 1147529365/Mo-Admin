<?php include_once 'header.php'; ?>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <p>当前版本：<span id="sys_ver">2.0</span>
                        <span id="ver_data">
							<a id="ver_url" href="javascript:void(0);" onclick="check_ver()"><span
                                        class="badge badge-pill badge-success" id="ver">最新</span></a>
						</span>
                    </p>
    ...
    <script>
        function init(e, t = {}) {
            return $.ajax({
                cache: !1, type: "POST", data: e, dataType: "json", success: function (e) {
                    200 == e.code ? (census(e.data.census), loading(!1), $("#sys_ver").html(e.data.census.server_info.sys_ver), $("#domain").html(e.data.census.server_info.domain), $("#php_ver").html(e.data.census.server_info.php_ver), $("#mysql_ver").html(e.data.census.server_info.mysql_ver), $("#serverapp").html(e.data.census.server_info.serverapp), $("#uploadfile_maxsize").html(e.data.census.server_info.uploadfile_maxsize)) : loading(!1)
        ...
        function logs(e) {
            e.length > 0 ? ($("#table_logs").attr("hidden", !1), $("#logs_state").attr("hidden", !0)) : ($("#logs_state").attr("hidden", !1), $("#table_logs").attr("hidden", !0)), $("#tbody_logs").empty();
            for (var t = 0; t < e.length; t++) {
                var s = "<tr><td>" + e[t].id + "</td><td>" + e[t].user + '<br /><span class="small text-muted">' + e[t].person + '</span></td><th scope="col">' + e[t].type + '<br /><span class="small text-muted">操作类型</span></th><td>' + e[t].time + '<br /><span class="small text-muted">' + e[t].ip + '</span></td><td><span class="dot dot-lg bg-' + ("y" == e[t].state ? "success" : "danger") + '"></span></td></tr>';
                $("#tbody_logs").append(s)
            }
        }

        function order_census(e) {
            var t = e.date, s = {
                chart: {
                    height: 350,
                    type: "line",
                ...
                series: [{name: "订单数", data: e.all}, {name: "成功数", data: e.success}],
