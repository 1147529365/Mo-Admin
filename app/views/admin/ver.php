<?php include_once 'header.php'; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                            ...
                            <div class="col-3">
                                <div class="float-right">
                                    <div class="custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="mi_state"
                                               onclick="checked_state('mi_state_fieldset',!this.checked);">
                        ...
                        <div class="form-group row">
                            <label class="col-9 col-form-label">数据签名<span class="fe fe-help-circle ml-1"
                                                                              data-toggle="tooltip"
                                                                              title="可防止客户端发送数据被篡改"></span></label>
                            <div class="col-3">
                                <div class="float-right">
                                    <div class="custom-switch">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-6 col-form-label">时差校验<span class="fe fe-help-circle ml-1"
                                                                                 data-toggle="tooltip"
                                                                                 title="可校验客户端时间和服务器时间，避免客户端利用时间漏洞非法使用软件"></span></label>
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="number" class="form-control" placeholder="校验数据是否超时"
                                           id="mi_time" value="100">
                        ...
                        <fieldset id="mi_state_fieldset" hidden>
                                    ...
                                    <div class="float-right">
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="mi_rc4" name="mi_type"
                                                       class="custom-control-input" checked
                                                       onclick="checked_mi('rc4');">
                                                <label class="custom-control-label" for="mi_rc4">RC4</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="mi_aes" name="mi_type"
                                                       class="custom-control-input" onclick="checked_mi('aes');">
                                                <label class="custom-control-label" for="mi_aes">AES</label>
                                            </div>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="mi_rsa" name="mi_type"
                                                       class="custom-control-input" onclick="checked_mi('rsa');">
                            ...
                            <div class="form-group row" id="mi_rc4_div">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="mi_rc4_key" rows="2"
                                              placeholder="密钥长度16~32位"></textarea>
                                </div>
                            </div>
                            <div class="form-group" id="mi_aes_div" hidden>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="mi_aes_key" rows="2"
                                                  placeholder="密钥长度必须为32"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-sm-4">AESIV</label>
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="mi_aes_iv" rows="2"
                                                  placeholder="IV长度必须为16"></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" id="ver_new_content" rows="4"
                        ...
                        <div id="modal_edit_ver_state" hidden>
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <div class="float-right">
                                        <div class="custom-switch">
                                            <input type="checkbox" class="custom-control-input success" id="ver_state"
                                                   onclick="checked_state('ver_off_msg_div',this.checked);">
                            ...
                            <div class="form-group row" id="ver_off_msg_div" hidden>
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="ver_off_msg" rows="4"
                                              placeholder="如：当前客户端维护中"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function checked_mi(e) {
            "rsa" == e ? ($("#mi_rsa_div").attr("hidden", !1), $("#mi_aes_div").attr("hidden", !0), $("#mi_rc4_div").attr("hidden", !0)) : "aes" == e ? ($("#mi_aes_div").attr("hidden", !1), $("#mi_rc4_div").attr("hidden", !0), $("#mi_rsa_div").attr("hidden", !0)) : ($("#mi_aes_div").attr("hidden", !0), $("#mi_rsa_div").attr("hidden", !0), $("#mi_rc4_div").attr("hidden", !1))
        }
        ...
        $("#submit").click(function () {
            ...
            return $("#del_submit").html('<i class="spinner-ui fe fe-rotate-cw fe-12 mr-2"></i>正在删除'), $("#del_submit").attr("disabled", !0), $.ajax({
                ...
                dataType: "json",
                success: function (i) {
                    if ($("#del_submit").html("确认删除"), $("#del_submit").attr("disabled", !1), 200 == i.code) if ($("#ver_" + e).remove(), cocoMessage.success(i.msg, 2e3), $("#del_ver").modal("hide"), $("#ver_list").children().length >= 13) $("#add_ver").attr("hidden", !0); else $("#add_ver").attr("hidden", !1); else cocoMessage.error(i.msg, 2e3)
                }
            }), !1
        });
    </script>
